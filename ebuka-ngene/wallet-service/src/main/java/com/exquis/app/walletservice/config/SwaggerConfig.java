...
@Configuration
@EnableSwagger2
@ComponentScan("com.exquis.app.user.controller")
public class SwaggerConfig {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("MoneyPal Wallet Service REST API")
                .description("MoneyPal Wallet Service REST API developed by Chukwuebuka")
                .version("1.0.0")
