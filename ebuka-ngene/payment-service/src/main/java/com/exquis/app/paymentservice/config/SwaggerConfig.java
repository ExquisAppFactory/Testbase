...
@Configuration
@EnableSwagger2
@ComponentScan("com.exquis.app.paymentservice.controller")
public class SwaggerConfig {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("MoneyPal Payment Service REST API")
                .description("MoneyPal Payment Service REST API developed by Chukwuebuka")
                .version("1.0.0")
